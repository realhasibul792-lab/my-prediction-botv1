 ...
 * এটি Render-কে সিগন্যাল দেয় যে আপনার অ্যাপটি সচল আছে।
 */
...
async function checkAndPredict() {
    ...
    try {
        ...
        // ৪১ সেকেন্ডের পরে এবং ৫০ সেকেন্ডের আগে প্রেডিকশন দিলে সঠিক সময় পাওয়া যায়
        if (currentPeriod !== lastAnalyzedPeriod && seconds >= 41 && seconds <= 50) {
            ...
            let prediction = chartData[`${n1}/${n2}`] || "BIG";
...
bot.onText(/\/report/, (msg) => {
    let summary = `🏆 Wins: ${totalWinCount} | ❌ Losses: ${totalLossCount}`;
